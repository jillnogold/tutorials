...
<table width='100%' align="left"> 
    ...
    <td align="left" style='min-width:45px;'>
   	...
   	<tr>
    <td style='min-width:45px;'>
        <b>	<a href="https://github.com/mlrun/demo-monitoring-and-feedback-loop/blob/main/README.md">Train, deploy, and monitor LLM using "LLM as a judge"</a></b>
        </td>
